...
class InvoicePDFView(DetailView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        # Dados do emitente (substitua pelos dados reais da empresa)
        ...
        # Dados do destinatário (dados do cliente)
        client = sale.client
        ...
        # Ajuste das colunas: 
        # Produto: a partir de margin + 5
        # Qtd: a partir de margin + 190
        # Valor Unit: a partir de margin + 240
        # Total: right aligned
        ...
        p.drawCentredString(width / 2, 20, "Empresa XYZ Ltda. - Nota Fiscal Eletrônica (SEM VALIDADE FISCAL) | Contato: (65) 9 9336-1717")
